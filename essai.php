 ...
 <section class="presentation">
  ...
  <aside style="display:flex;margin:0;"> 
     <article style="width: 45%;border-right:solid gray 5px;display:block;">   
        ...
        <p style="height:80px;text-indent:10px;"><a href="https://societegenerale.bf/fr/votre-banque/recrutement/" target="_blank" title="Ouvrir le lien de recrutement"><img alt="" src="imagesprojet/logo-societe-generale.jpg" style="width:130px; height:80px; float:left; margin-left:-100px;border: solid 1px black;border-radius:3px; "/></a>
      ...
      <hr/>
                              ...
                              <!--================Les demandes===============================-->
       <article style="width: 25%;border-right:solid 5px gray ;display:block;">
             ...
             <img alt="Profil" src="imagesprojet/profil1.jpg" style="height: 100px;width:100px;border-width:1px;border-style:solid;margin-left:-100px; float:left;" />
                                              ...
                                              <a href="listedesinscrits/#SANOUDESIRE" target="_blank"><b>Voir le cv</b></a><br/>
               </p>
               <hr/>
               <p style="height:15%;text-indent:5px;">
             <img alt="Profil" src="imagesprojet/profil1.jpg" style="height: 100px;width:100px;border-width:1px;border-style:solid;margin-left:-100px; float:left;" />
            ...
            <article style="width:30%;border:solid gray hidden;display:block;">
                    <h4 style="color:#A52A2A;font-family:tahoma,geneva,sans-serif;font-size:15px;"><a href="listeEntreprises.html" title=""><u>Ils nous font confiance!</u></h4>
                      <hr/>
                            <p><img alt="" src="imagesprojet/logo-societe-generale.jpg" style="width: 130px; height: 78px; float: left; border: solid 1px black;border-radius:3px; margin-right:2px;"/></p>

                            <p style="text-align: center;"><img alt="ebomaf" src="imagesprojet/EBOMAF.jpg" style="height: 84px; width: 130px; border-width: 1px; border-style: solid; margin: 1px; float: left;" /></p>

                            <p><img alt="ebomaf" src="imagesprojet/EBOMAF.jpg" style="height: 84px; width: 130px; border-width: 1px; border-style: solid; margin: 1px; float: left;" /></p> 
                            <p><img alt="ebomaf" src="imagesprojet/EBOMAF.jpg" style="height: 84px; width: 130px; border-width: 1px; border-style: solid; margin: 1px; float: left;" /></p> 
                            <p><img alt="ebomaf" src="imagesprojet/EBOMAF.jpg" style="height: 84px; width: 130px; border-width: 1px; border-style: solid; margin: 1px; float: left;" /></p> 
                            <p><img alt="ebomaf" src="imagesprojet/EBOMAF.jpg" style="height: 84px; width: 130px; border-width: 1px; border-style: solid; margin: 1px; float: left;" /></p> 
           </article>
